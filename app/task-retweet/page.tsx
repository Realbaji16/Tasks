          ...
          <div className="flex-1 p-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 w-full gap-6">
                ...
                {tasks.map((task, i) => {
                  ...
                  switch (task.title) {
                    ...
                    case "Quote tweet":
                      ...
                      break;
                    default:
                      route = "/task-retweet"; // Default route for "Retweet Post"
                  }

                  const isActive = task.title === "Retweet Post"; // Check if the current task is "Retweet Post"

                  return (
                    <Link href={route} key={i}>
                      <div
                        className={`p-[2px] rounded-[20px] ${
                          isActive ? "bg-gradient-to-r from-[#00FFA3] to-[#DC1FFF]" : ""
                        } cursor-pointer hover:bg-opacity-90`}
                      >
                        <div
                          className={`flex items-center justify-between ${
                            isActive ? "bg-[#171717]" : "bg-[#1e1e1e]"
                          } px-4 py-2 rounded-[18px] text-white`}
                        >
                          <div>
              ...
              <div className="col-span-3 bg-[#171717] rounded-[20px] p-6 text-white lg:w-[70%] h-[70%]">
                ...
                <p className="text-center my-8 flex justify-center items-center gap-2">
                  <img src="/twe.svg" alt="Twitter Icon" className="" />
                  Retweet the post with the link below
                </p>
