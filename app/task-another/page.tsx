...
export default function Taskanother() {
  ...
  return (
    <div className="bg-black">
      <main className="bg-black min-h-screen py-4 pt-2 lg:flex flex-col lg:flex-row justify-center mx-auto font-inter">
        ...
        {/* Slide-Out Menu */}
        {menuOpen && (
          <div className="lg:hidden fixed top-0 right-0 w-3/4 h-full bg-[#171717] z-50 px-8 p-5 overflow-y-auto">
            <button onClick={toggleMenu} className="text-white text-2xl absolute mt-4 right-4">
              ✖
            </button>
            ...
            <div className="mt-8">
              ...
              <Card className="w-full bg-transparent border border-[#494949] rounded-[20px] p-4">
                <CardContent className="flex flex-col gap-2">
                  ...
                  <p className="text-gray-400 text-sm">Earn up to 1000 points per day</p>
          ...
          <div className="flex-1 p-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 w-full gap-6">
              <div className="hidden lg:block col-span-2 space-y-4">
                <div
                  className="bg-cover bg-center rounded-[20px] p-4 text-white w-full"
                  style={{ backgroundImage: "url('./imgbg.svg')" }}
                >
                  <p className="text-lg font-semibold">Boost & Shill: Light Social Actions</p>
                ...
                {tasks.map((task, i) =>
                  i === 3 ? (
                    <div
                      key={i}
                      className="p-[2px] rounded-[20px] bg-gradient-to-r from-[#00FFA3] to-[#DC1FFF]"
                    >
              ...
              <div className="col-span-3 bg-[#171717] rounded-[20px] p-6 text-white lg:w-[70%] lg:h-[70%]">
                ...
                <p className="my-8 flex justify-center items-center gap-2 text-center">
                  <img src="/twe.svg" alt="Twitter Icon" />
                  <span>Find someone yappin’ about Gigsol <br /> and smash that RT</span>
                </p>
